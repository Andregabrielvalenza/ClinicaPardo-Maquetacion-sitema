                    ...
                    <div class="col-sm-12 col-lg-8">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">Editar Sucursal - {{$sucursal->cliente->razon_social}}</h4>
                            ...
                            <div class="panel-body nopadding">
                                {!! Form::model($sucursal, ['method' => 'PATCH','route' => ['sucursales.update', $sucursal->id], 'class'=>'form-horizontal form-bordered']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::text('dni_responsable_tecnico', null, array('placeholder' => 'DNI/CIP','class' => 'form-control','maxlength'=>'8','minlength'=>'5','required')) !!}
