                ...
                <div class="col-sm-12 col-lg-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body nopadding">
                            {!! Form::model($user, ['method' => 'PATCH','route' => ['users.update', $user->id], 'class'=>'form-horizontal form-bordered']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::select('roles[]', $roles,$userRole, array('class' => 'width300','multiple', 'id'=>'roles', 'data-placeholder'=>'Seleccionar roles')) !!}
