                ...
                <div class="col-sm-12 col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Editar Vehiculo de transporte</h4>
                        ...
                        <div class="panel-body nopadding">
                            {!! Form::model($vehiculo, ['method' => 'PATCH','route' => ['vehiculos.update', $vehiculo->id], 'class'=>'form-horizontal form-bordered']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::select('residuos[]', $residuos, $vehiculoResiduos, array('class' => 'width300','multiple', 'required', 'id'=>'residuos', 'data-placeholder'=>'Seleccionar residuos')) !!}
