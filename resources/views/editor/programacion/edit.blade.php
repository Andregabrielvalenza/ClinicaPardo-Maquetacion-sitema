                ...
                <div class="col-sm-12 col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Editar Programacion</h4>
                        ...
                        <div class="panel-body nopadding">
                            {!! Form::model($programacion, ['method' => 'PATCH','route' => ['programaciones.update', $programacion->id], 'class'=>'form-horizontal form-bordered']) !!}
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Fecha<code>(*)</code></label>
                                <div class="input-group col-sm-8">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                    <div class=" bootstrap-timepicker">
                                        {!! Form::text('fecha', date("d-m-Y",strtotime($programacion->fecha)), array('placeholder' => 'Fecha de recepción','class' => 'form-control','required', 'id'=>'fecha')) !!}
                                    </div>
                                </div>
                            </div><!-- form-group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-8">
                                    ...
                                    <div class=" bootstrap-timepicker">
                                        {!! Form::text('hora', '', array('placeholder' => 'Hora de recepción','class' => 'form-control','required', 'id'=>'hora')) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::select('sucursal_id', $sucursales,null, array('class' => 'width300', 'id'=>'sucursal_id', 'data-placeholder'=>'Seleccionar dirección','required')) !!}
...
@section('scripts')
    <script>
        var fecha='{{date("h:i A",strtotime($programacion->hora))}}'
        console.log(fecha);
        $(document).ready(function() {
            ...
            $('#hora').timepicker({ minuteStep: 15, defaultTime:fecha});
