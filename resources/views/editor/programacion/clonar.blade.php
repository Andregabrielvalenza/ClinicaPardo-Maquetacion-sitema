                    ...
                    <div class="col-sm-12 col-lg-8">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">Clonar una recepcion</h4>
                                ...
                                {!! Form::open(array('route' => 'programaciones.store','method'=>'POST','class'=>'form-horizontal form-bordered')) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-sm-8">
                                            ...
                                            <div class=" bootstrap-timepicker">
                                                {!! Form::text('hora', $programacion->hora, array('placeholder' => 'Hora de recepción','class' => 'form-control','required', 'id'=>'hora')) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select('cliente_id', array(""=>"Seleccionar cliente")+$clientes,$programacion->cliente_id, array('class' => 'width300', 'id'=>'cliente', 'data-placeholder'=>'Seleccionar Cliente','required')) !!}
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="sucursal_id" class="width300" id="sucursal_id" data-placeholder="Seleccionar dirección" required>
                                            @foreach ($programacion->cliente->sucursales as $su)
                                                <option value="{{$su->id}}" @if($su->id==$programacion->sucursal_id) selected @endif>{{$su->direccion}} {{$su->numero}}</option>
                                            @endforeach
                                            </select>
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select('transporte_id', array(""=>"Seleccionar vehiculo")+$transportes,$programacion->transporte_id, array('class' => 'width300', 'id'=>'transporte', 'data-placeholder'=>'Seleccionar Transporte','required')) !!}
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select('conductor_id', array(""=>"Seleccionar conductor")+$conductores,$programacion->conductor_id, array('class' => 'width300', 'id'=>'conductor', 'data-placeholder'=>'Seleccionar Conductor','required')) !!}
                                        </div>
                                    </div><!-- form-group -->
