        ...
        <div class="pageheader">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <h4>Historial de Manifiestos</h4>
                </div>
            </div><!-- media -->
        </div><!-- pageheader -->
        ...
        <div class="contentpanel">
            ...
            <div class="panel panel-dark-head">
                <div class="panel-heading" style="margin-bottom:2rem;">
                    ...
                    <h2 class="panel-title">Historial de Manifiestos</h2>
                    <p>En esta sección puedes acceder a todo el historial de los manifiestos.</p>
                </div><!-- panel-heading -->
