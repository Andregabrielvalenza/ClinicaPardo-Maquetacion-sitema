            ...
            <div class="media">
                ...
                <div class="media-body">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="{{ route('redes') }}">Mis redes</a></li>
                    </ul>
                ...
                <div class="col-sm-12 col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Registrar nueva Red</h4>
                        ...
                        <div class="panel-body nopadding">
                            {!! Form::open(array('route' => 'empresas.store','method'=>'POST','class'=>'form-horizontal form-bordered')) !!}
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Nombre de la red <code>(*)</code></label>
                                <div class="col-sm-8">
                                    {!! Form::text('nombre_comercial', null, array('placeholder' => '','class' => 'form-control','required')) !!}
