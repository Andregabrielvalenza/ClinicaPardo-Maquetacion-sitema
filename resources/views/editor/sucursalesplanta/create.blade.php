                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="#!">Residuos Solidos</a></li>
                    ...
                    <div class="col-sm-12 col-lg-8">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">Registrar Sucursal - {{$planta->razon_social}}</h4>
                            ...
                            <div class="panel-body nopadding">
                                {!! Form::open(array('route' => 'sucursales-planta.store','method'=>'POST','class'=>'form-horizontal form-bordered')) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::hidden('planta_id', $planta->id, array('placeholder' => 'Planta','class' => 'form-control')) !!}
