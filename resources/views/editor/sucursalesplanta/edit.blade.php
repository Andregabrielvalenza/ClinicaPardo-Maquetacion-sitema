                    ...
                    <div class="col-sm-12 col-lg-8">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">Editar Sucursal - {{$sucursal->planta->razon_social}}</h4>
                            ...
                            <div class="panel-body nopadding">
                                {!! Form::model($sucursal, ['method' => 'PATCH','route' => ['sucursales-planta.update', $sucursal->id], 'class'=>'form-horizontal form-bordered']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::select('departamento', array(""=>"Seleccionar Departamento")+$departamentos,$departamento_sucursal->id, array('class' => 'width300', 'id'=>'departamento', 'data-placeholder'=>'Seleccionar departamento','required')) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::select('provincia', $provincias,$provincia_sucursal->id, array('class' => 'width300', 'id'=>'provincia', 'data-placeholder'=>'Seleccionar provincia','required')) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::select('distrito_id', $distritos,$sucursal->distrito_id, array('class' => 'width300', 'id'=>'distrito', 'data-placeholder'=>'Seleccionar distrito','required')) !!}
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">DNI<code>(*)</code></label>
                                    <div class="col-sm-8">
                                ...
                                <div class="well well-sm text-center"><b>DATOS RESPONSABLE TÉCNICO</b></div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Nombres y Apellidos<code>(*)</code></label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::text('dni_responsable_tecnico', null, array('placeholder' => 'DNI','class' => 'form-control','maxlength'=>'8','minlength'=>'8')) !!}

                                    </div>
                                </div><!-- form-group -->

                                <div class="form-group">
                                    <label class="col-sm-4 control-label">CIP<code>(*)</code></label>
                                    <div class="col-sm-8">
                                        {!! Form::text('cip_responsable_tecnico', null, array('placeholder' => 'CIP','class' => 'form-control', 'required')) !!}
